...
def tg_hier(tg_path):
    ...
    bubble_intervals= tg[8]
    strong_intervals= tg[9]
    weak_intervals= tg[10]
    ...
    bubble_list=[]
    for t in bubble_intervals:
        bubble_list.append(t.mark)
    
    strong_list=[]
    for t in strong_intervals:
        strong_list.append(t.mark)
    
    weak_list=[]
    for t in weak_intervals:
        weak_list.append(t.mark)
    ...
    for n,ph in enumerate(ph_intervals):
        ...
        if min>=word_dict_list[idx]['start_time'] and max<=word_dict_list[idx]['end_time']:
            ...
            word_dict_list[idx]['bubble'].append(bubble_list[n])
            word_dict_list[idx]['strong'].append(strong_list[n])
            word_dict_list[idx]['weak'].append(weak_list[n])
        else:
            idx = idx + 1
            if min>=word_dict_list[idx]['start_time'] and max<=word_dict_list[idx]['end_time']:
                word_dict_list[idx]['ph'].append(mark)
        ...
        if word_dict_list[idx]['bubble']=='1':
            word_dict_list[idx]['tech']+=' 7'
        if word_dict_list[idx]['strong']=='1':
            word_dict_list[idx]['tech']+=' 8'
        if word_dict_list[idx]['weak']=='1':
            word_dict_list[idx]['tech']+=' 9'
